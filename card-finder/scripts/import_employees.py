#!/usr/bin/env python3
"""Convert a Slack member export (JSON) into data/employees.js.
...
guest-less placeholder accounts are skipped. Cards people already entered in
data/employees.js are kept when their id matches.
"""
import json
import re
import sys
...
def main(path):
    ...
    OUT.write_text(
        ...
        "// Each employee lists card ids from data/cards.js.\n"
        f"window.EMPLOYEES = [\n{body}\n];\n",
        encoding="utf-8",
    )
